...
const Testimonials = () => {
  return (
    <>
      <div className='w-[400px] md:w-[700px] lg:w-[1000px] xl:w-[1200px] mx-auto mb-32'>
        ...
        >
          {Content.map(testimonial => (
            ...
            <SwiperSlide
              key={testimonial.id}
              className='text-center bg-white drop-shadow-lg cursor-pointer rounded-3xl border before:content-[""] after:content-[""] before:absolute after:absolute before:right-0 after:right-0 before:bottom-20 after:bottom-20 before:h-[1.5rem] after:h-[1.5rem] before:w-[1.5rem] after:w-[1.5rem] before:bg-brandColor after:bg-white after:rounded-br-2xl'
            >
              <span className='absolute top-10 left-10'>
                {testimonial.rating}
              </span>
              <img
                className='w-20 absolute -top-5 right-10 rotate-180'
                src={quotation}
                alt=''
              />
              <p className='font-semibold text-[1.1rem] w-64 my-10 mx-auto leading-relaxed mt-24'>
                {testimonial.content}
              </p>
